...
if __name__ == "__main__":
    agent = PPOAgent(num_envs=100, num_steps=128, num_updates=10, hidden_size=128,
                     grid_size=20, view_size=5, max_hunger=100, num_trees=1, num_predators=1, results_path=None)
    agent.train()
